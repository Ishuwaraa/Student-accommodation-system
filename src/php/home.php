<main>
    <article class="article">
      ...
      <!--Latest Student Houses-->

      <section class="property" id="property">
        <div class="container">

          <h2 class="h2 section-title">Latest Student Accommodation</h2>
          <p class="section-subtitle">Latest Student Houses</p>
          <br>
      ...
      <!-- Latest Students Flats-->
      <br>
      <section class="property" id="property">
          <div class="container">
  
            
            <p style="font-size: 2.5rem; color:hsl(224, 34%, 13%); padding-bottom: 20px; text-decoration:solid;">Latest Student Flats</p>
            <br>
            <ul class="property-list has-scrollbar" style="overflow-x: auto;">
              <!--Card 1-->
              <li>
