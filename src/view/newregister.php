    ...
    <!--------------------------- Left Box ----------------------------->
       <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box" style="background: #8DCA3C;">
           <div class="featured-image mb-3">
            <img src="login.jpg" class="img-fluid" style="width: 450px;">
           </div>
       ...
       <div class="col-md-6 right-box">
          <div class="row align-items-center">
                ...
                <div class="input-group mb-3" style="margin-top: 20px;">
                    <button class="btn btn-lg w-100 fs-6" style="background-color: #8DCA3C; color: #fff; border-radius: 10rem;" >Register</button>
                </div>
            
                <div class="row">
                    <small>Already has an account? <a href="#">Sign In</a></small>
                </div>
          </div>
       </div> 
      </div>
